...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : PB10 Drive_READ_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_10|Drive_READ_Pin;
  ...
  /*Configure GPIO pin : HV_READ_Pin */
  GPIO_InitStruct.Pin = HV_READ_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(HV_READ_GPIO_Port, &GPIO_InitStruct);
